<x-filament::dropdown placement="bottom-end">
    ...
    <x-slot name="trigger" @class([
        ...
        <div
            class="flex items-center justify-center w-10 h-10 font-semibold text-white bg-center bg-cover rounded-full language-switch-trigger dark:bg-gray-900">
            <span>
                <x-dynamic-component :component="'flag-1x1-' . (app()->getLocale() == 'en' ? 'us' : app()->getLocale())"
